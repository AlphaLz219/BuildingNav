...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        dest="include_roof",
        action="store_false",
        help="Do not generate the roof slab on top of the building (open-top building).",
    )
    parser.set_defaults(write_generated_truth_copy=True, include_roof=True)
    return parser

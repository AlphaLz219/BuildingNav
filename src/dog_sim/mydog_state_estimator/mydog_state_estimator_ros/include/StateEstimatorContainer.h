...
//  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  Eigen::Matrix<T, 4, 1> contactEstimate;
  Eigen::Matrix<T, 3, 1> position;
  Eigen::Matrix<T, 3, 1> vBody;
  Eigen::Quaternion<T> orientation;
  Eigen::Matrix<T, 3, 1> omegaBody;
  Eigen::Matrix<T, 3, 3> rBody;
  Eigen::Matrix<T, 3, 1> rpy;

  Eigen::Matrix<T, 3, 1> omegaWorld;
  Eigen::Matrix<T, 3, 1> vWorld;
  Eigen::Matrix<T, 3, 1> aBody, aWorld;
